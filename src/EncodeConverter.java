...
import java.util.Date;
 ...
 public class EncodeConverter {  
     ...
     private static String srcDir = "K:\\ImportRoot\\SiteCensus\\Source\\src";
     
     private static String desDir = "K:\\ImportRoot\\SiteCensus\\Source\\des";
     ...
     {      
         ...
         for (File subFile : files) {      
             ...
             if (subFile.isDirectory()) {      
                 ...
                 System.err.println("Source File：\t"+subFile.getAbsolutePath() + "\nTarget File：\t" + (desDir + subFile.getAbsolutePath().substring(srcDir.length())));      
                 System.err.println("-----------------------------------------------------------------");
